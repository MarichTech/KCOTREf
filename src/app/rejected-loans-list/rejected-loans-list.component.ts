...
@Component({
  selector: 'app-rejected-loans-list',
  templateUrl: './rejected-loans-list.component.html',
  styleUrls: ['./rejected-loans-list.component.css']
})
export class RejectedLoansListComponent implements OnInit {
