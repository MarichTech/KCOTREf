 ...
 const documentDefinition = {
    content: [
      ...
      
      {
        ...
        table: {
          ...
          {text: '6th', style: 'tableHeader', alignment: 'center'}],
            ...
            ['a) Cash in the bank at the start of the month', '', '', '', '', '', ''],
      ...
      },
      {
        style: 'normal1',
        text:[
        {text:'Approximate value of security '},
        {text:IsBooksUpToDate, style: 'reply'}
         ]
      },
      {
      ...
      },
      {
        ...
        table: {
          ...
          {text: 'REMARK', style: 'tableHeader', alignment: 'center'}],
            ...
            [{text: '1', style: 'tableHeader'},{text: 'Purpose', style: 'tableHeader'}, '30', '', ''],
            [{text: '2', style: 'tableHeader'},{text: 'Character ', style: 'tableHeader'}, '25', '', ''],
            [{text: '3', style: 'tableHeader'},{text: 'Security  ', style: 'tableHeader'}, '20', '', ''],
            [{text: '4', style: 'tableHeader'},{text: 'Ability', style: 'tableHeader'}, '15', '', ''],
            [{text: '5', style: 'tableHeader'},{text: 'Amount', style: 'tableHeader'}, '10', '', ''],
            [{text: 'Total', style: 'tableHeader', alignment: 'center', colSpan: 2},{text: '', style: 'tableHeader'}, '', '', '']
