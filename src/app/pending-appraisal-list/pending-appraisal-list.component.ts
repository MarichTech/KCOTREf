...
@Component({
  selector: 'app-pending-appraisal-list',
  templateUrl: './pending-appraisal-list.component.html',
  styleUrls: ['./pending-appraisal-list.component.css']
})
export class PendingAppraisalListComponent implements OnInit {
